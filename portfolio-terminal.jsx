...
const COMMANDS = {
  ...
  nmap: () => [
    ...
    '  51820/udp open     wireguard   WireSeal v1.0.0 (audited)',
    '  8080/tcp  filtered http        [dashboard — localhost-only]',
    '',
  ...
  wireseal: () => [
    '  ╔══ WireSeal v1.0.0 — security audited ════════════╗',
    '  ║  zero-trust wireguard gateway · zero plaintext   ║',
    '  ╠══════════════════════════════════════════════════╣',
    '  ║  vault:       dual-layer AEAD (Argon2id + HKDF)  ║',
    '  ║  layer 1:     ChaCha20-Poly1305 [inner]          ║',
    '  ║  layer 2:     AES-256-GCM-SIV   [outer]          ║',
    '  ║  2fa:         TOTP RFC 6238 · PBKDF2 backup     ║',
    '  ║  access:      RBAC · 15+ privileges · TTL       ║',
    '  ║  audit:       SHA-256 hash-chained log          ║',
    '  ║  platforms:   linux · macos · windows · rpi     ║',
    '  ║  commits:     295   releases: 59                 ║',
    '  ╚══════════════════════════════════════════════════╝',
    '  github: https://github.com/prashanth-7861/WireSeal',
    '  audit:  SECURITY_AUDIT_v1.0.0.md',
    '  site:   https://wireseal.vercel.app',
    ''
  ],
  certifications: () => [
